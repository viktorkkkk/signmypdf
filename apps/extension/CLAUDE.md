...
- **Sign PDF Extension v2.6.0** — standalone Chrome MV3 extension.
...
## 5. Current Feature State (v2.6.0)
...
- **Production icons** (16 / 32 / 48 / 128 PNG). Current placeholders are a
  pen silhouette on `#2563eb` generated by
  [scripts/make-placeholder-icons.mjs](scripts/make-placeholder-icons.mjs).
